package ru.merkulyevsasha.laws
...
import kotlinx.android.synthetic.main.fragment_laws.adView
import kotlinx.android.synthetic.main.fragment_laws.recyclerView
import kotlinx.android.synthetic.main.fragment_laws.swipeRefreshLayout
...
class LawsFragment : Fragment(), LawsView, RequireGDServiceLocator {
    ...
    companion object {
        @JvmStatic
        val TAG: String = LawsFragment::class.java.simpleName

        @JvmStatic
        fun newInstance(): Fragment {
            val fragment = LawsFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
        inflater.inflate(R.layout.fragment_laws, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbar.setTitle(R.string.bottom_button_laws_title)
